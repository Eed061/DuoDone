...
export const HouseholdShareModal: React.FC = () => {
  ...
  const inviteLink = `https://t.me/DuoDoneBot?start=join_${household.invite_code || 'DUO7789'}`;
  ...
  return (
    <div className="bg-slate-800/90 border border-slate-700/80 rounded-2xl p-4 shadow-lg space-y-4">
      <div className="flex items-center space-x-2 border-b border-slate-700/60 pb-3">
        ...
        <div>
          <h3 className="font-bold text-white text-base">Налаштування Простору</h3>
          <p className="text-xs text-slate-400">Управління домом та підключення другої половинки</p>
        </div>
      </div>
