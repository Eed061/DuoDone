...
export const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    hsm_invite_code: 'Code : {code}',
    hsm_invite_desc: 'Envoyez une carte d\'invitation à votre partenaire pour vérification automatique.',
    hsm_invite_msg: '🤝 Salut ! Je t\'invite à gérer notre foyer ensemble dans DuoDone ! 🏓✨\n\nAccepte l\'invitation en tant que mon partenaire ({partner}) :\n{link}',
    ...
    hsm_join_error: 'Code non trouvé dans le cloud.',
    ...
    hsm_space_full_error: 'Cet espace a déjà 2 partenaires. Créez votre propre espace !',
    ...
    sm_disconnect_confirm: 'Déconnecter le partenaire de cet espace ? Le code d\'invitation sera réouvert pour un nouveau compte.',
    sm_delete_space: 'Supprimer l\'espace',
    sm_delete_confirm: 'Supprimer cet espace ? Toutes les tâches et données de cet espace seront supprimées.',
    sm_manage_spaces_btn: 'Gérer les espaces ⚙️',
    sm_active_badge: 'Actif',
    sm_switch_btn: 'Choisir',
    eum_photo_name: 'Photo & Nom',
    eum_change_photo: 'Changer la photo',
  ...
  ru: {
    ...
    hsm_subtitle: 'Имена партнеров, название дома и приглашения',
    ...
    hsm_reset_cycle_confirm: 'Обнулить баллы XP и начать новый месяц?',
    hsm_confirm_cycle: 'Да, начать цикл',
    hsm_factory_reset: 'Начать заново (Заводские настройки)',
    hsm_factory_reset_confirm: 'Внимание! Сбросить ВСЕ данные, баллы и вернуть шаблоны?',
    hsm_reset_all_btn: 'Сбросить все!',
    hsm_partner_invite: 'Приглашение партнера',
    hsm_invite_code: 'Код: {code}',
    hsm_invite_desc: 'Отправьте карточку приглашения партнеру для автоматической верификации и синхронизации в одном «Доме».',
    hsm_invite_msg: '🤝 Привет! Приглашаю тебя вести совместный быт в DuoDone! 🏓✨\n\nПринять приглашение и верифицироваться как мой партнер ({partner}):\n{link}',
    hsm_invite_title: 'Приглашение DuoDone',
    hsm_join_code_label: 'Присоединиться к Дому партнера по коду',
    hsm_join_code_ph: 'Введите код, например DUO-7789',
    hsm_join_btn: 'Присоединиться',
    hsm_join_success: 'Успешно присоединены к общему Дому!',
    hsm_join_error: 'Код не найден в облаке. Проверьте правильность.',
    ...
    hsm_space_full_error: 'Это пространство уже сформировано для 2 партнеров. Создайте свое новое пространство!',
    header_my_spaces: 'Ваши пространства',
    header_create_space: '➕ Создать новое пространство',
    csm_title: 'Создание Нового Пространства',
    ...
    sm_subtitle: 'Просмотр, редактирование пространств и настройка доступа',
    sm_disconnect_partner: 'Отключить партнера',
    sm_disconnect_confirm: 'Отключить партнера из этого пространства? Код приглашения снова станет открыт для подключения второго аккаунта.',
    sm_delete_space: 'Удалить пространство',
    sm_delete_confirm: 'Удалить это пространство? Все задачи и данные этого пространства будут удалены.',
    sm_manage_spaces_btn: 'Управление пространствами ⚙️',
    sm_active_badge: 'Активный',
    sm_switch_btn: 'Выбрать',
