...
const TITLE_LOCALIZATIONS: Record<string, Record<Language, string>> = {
  ...
  'Наш затишний дім': {
    uk: 'Наш затишний дім',
    en: 'Our Cozy Home',
    pl: 'Nasz przytulny dom',
    de: 'Unser gemütliches Zuhause',
    es: 'Nuestro acogedor hogar',
    fr: 'Notre maison douillette',
    ru: 'Наш уютный дом',
  },
  'Миття посуду': {
    uk: 'Миття посуду',
...
export const translations: Record<Language, Record<string, string>> = {
  uk: {
    ...
    // Household Share Modal
    hsm_title: 'Налаштування Простору та Партнерів',
    hsm_subtitle: 'Імена партнерів, назва дому та запрошення',
    hsm_partners_in_app: 'Партнери у застосунку',
    and: 'та',
    hsm_edit_data: 'Редагувати дані',
    hsm_space_name_label: 'Назва вашого простору',
    update_btn: 'Оновити',
    hsm_cycle_control_header: 'Керування циклами та Даними',
    hsm_start_new_cycle: 'Почати новий місячний цикл',
    hsm_reset_cycle_confirm: 'Обнулити бали XP та розпочати новий місяць?',
    hsm_confirm_cycle: 'Так, почати цикл',
    hsm_factory_reset: 'Почати заново (Заводські налаштування)',
    hsm_factory_reset_confirm: 'Увага! Скинути ВСІ дані, бали та повернути шаблонні завдання й призи?',
    hsm_reset_all_btn: 'Скинути все!',
    hsm_partner_invite: 'Запрошення партнера',
    hsm_invite_code: 'Код: {code}',
    hsm_invite_desc: 'Надішліть картку запрошення партнеру для автоматичної верифікації та синхронізації в одному спільному «Домі».',
    hsm_invite_msg: '🤝 Привіт! Запрошую тебе вести спільний побут у DuoDone! 🏓✨\n\nПрийняти запрошення та верифікуватися як мій партнер ({partner}):\n{link}',
    hsm_invite_title: 'Запрошення DuoDone',
    hsm_join_code_label: 'Приєднатися до Дому партнера по коду',
    hsm_join_code_ph: 'Введіть код, наприклад DUO-7789',
    hsm_join_btn: 'Приєднатися',
    hsm_join_success: 'Успішно приєднано до спільного Дому!',
    hsm_join_error: 'Код не знайдено в хмарі. Перевірте правильність.',
    hsm_space_status_locked: '🔒 Захищено (2/2 партнери)',
    hsm_space_status_open: '🟡 Очікує 2-го партнера (1/2)',
    hsm_space_create_btn: '➕ Створити новий простір',
    hsm_space_full_error: 'Цей простір вже сформований для 2 партнерів. Створіть свій власний новий простір!',
    header_my_spaces: 'Ваші простори',
    header_create_space: '➕ Створити новий простір',
    csm_title: 'Створення Нового Простору',
    csm_subtitle: 'Ведіть окремий побут з іншим партнером',
    csm_name_label: 'Назва простору (наприклад: Побут з братом)',
    csm_name_ph: 'Введіть назву простору...',
    csm_submit_btn: 'Створити простір 🚀',
    csm_creating: 'Створення...',
    sm_title: 'Управління Просторами',
    sm_subtitle: 'Перегляд, редагування просторів та налаштування доступу',
    sm_disconnect_partner: 'Відключити партнера',
    sm_disconnect_confirm: 'Відключити партнера з цього простору? Код запрошення знову стане відкритим для приєднання другого акаунту.',
    sm_delete_space: 'Видалити простір',
    sm_delete_confirm: 'Видалити цей простір? Усі завдання та бали даного простору будуть вилучені.',
    sm_manage_spaces_btn: 'Управління просторами ⚙️',
    sm_active_badge: 'Активний',
    sm_switch_btn: 'Обрати',
    eum_photo_name: 'Фото та Ім\'я',
    eum_change_photo: 'Змінити фото',
    eum_partner1_ph: 'Ім\'я партнера 1',
    eum_partner2_ph: 'Ім\'я партнера 2',
    ...
    // Counter Modal
    cm_photo_req_desc: 'Обов’язково додайте 1 або 2 фото',
    cm_photo_opt_desc: 'Додайте до 2 фото за бажанням або підтвердіть без фото',
    ...
    cm_add_second_photo: '+ Додати 2-ге фото',
    cm_photos_count: '{count}/2 фото',
    ...
    cdm_timeline: 'Хронология дій ({count})',
  ...
  en: {
    ...
    // Household Share Modal
    hsm_title: 'Space & Partner Settings',
    hsm_subtitle: 'Partner names, home title & invites',
    hsm_partners_in_app: 'Partners in app',
    and: 'and',
    hsm_edit_data: 'Edit profiles',
    hsm_space_name_label: 'Your space name',
    update_btn: 'Update',
    hsm_cycle_control_header: 'Cycle & Data Management',
    hsm_start_new_cycle: 'Start new monthly cycle',
    hsm_reset_cycle_confirm: 'Reset XP points and start a new month?',
    hsm_confirm_cycle: 'Yes, start cycle',
    hsm_factory_reset: 'Start fresh (Factory reset)',
    hsm_factory_reset_confirm: 'Warning! Reset ALL data, points & restore template tasks?',
    hsm_reset_all_btn: 'Reset everything!',
    hsm_partner_invite: 'Partner Invitation',
    hsm_invite_code: 'Code: {code}',
    hsm_invite_desc: 'Send an invitation card to your partner for automatic verification and sync in one shared "Home".',
    hsm_invite_msg: '🤝 Hi! I invite you to manage household together in DuoDone! 🏓✨\n\nAccept invite and verify as my partner ({partner}):\n{link}',
    hsm_invite_title: 'DuoDone Invite',
    hsm_join_code_label: 'Join partner household by code',
    hsm_join_code_ph: 'Enter code, e.g. DUO-7789',
    hsm_join_btn: 'Join',
    hsm_join_success: 'Successfully joined shared household!',
    hsm_join_error: 'Code not found in cloud. Please check.',
    hsm_space_status_locked: '🔒 Protected (2/2 partners)',
    hsm_space_status_open: '🟡 Waiting for 2nd partner (1/2)',
    hsm_space_create_btn: '➕ Create new space',
    hsm_space_full_error: 'This space already has 2 partners. Please create your own new space!',
    header_my_spaces: 'Your Spaces',
    header_create_space: '➕ Create new space',
    csm_title: 'Create New Space',
    csm_subtitle: 'Manage a separate household with another partner',
    csm_name_label: 'Space Name (e.g., Home with Brother)',
    csm_name_ph: 'Enter space name...',
    csm_submit_btn: 'Create Space 🚀',
    csm_creating: 'Creating...',
    sm_title: 'Manage Spaces',
    sm_subtitle: 'View, edit spaces and manage partner access',
    sm_disconnect_partner: 'Disconnect partner',
    sm_disconnect_confirm: 'Disconnect partner from this space? The invite code will be reopened for a new account to join.',
    sm_delete_space: 'Delete space',
    sm_delete_confirm: 'Delete this space? All tasks and data in this space will be deleted.',
    sm_manage_spaces_btn: 'Manage spaces ⚙️',
    sm_active_badge: 'Active',
    sm_switch_btn: 'Switch',
    eum_photo_name: 'Photo & Name',
    eum_change_photo: 'Change photo',
    eum_partner1_ph: 'Partner 1 name',
    eum_partner2_ph: 'Partner 2 name',
    ...
    // Counter Modal
    cm_photo_req_desc: 'Please attach 1 or 2 photos',
    cm_photo_opt_desc: 'Add up to 2 optional photos or confirm without photo',
    ...
    cm_add_second_photo: '+ Add 2nd photo',
    cm_photos_count: '{count}/2 photos',
  ...
  pl: {
    ...
    // Household Share Modal
    hsm_title: 'Ustawienia Przestrzeni i Partnerów',
    hsm_subtitle: 'Imiona partnerów, nazwa domu i zaproszenia',
    hsm_partners_in_app: 'Partnerzy w aplikacji',
    and: 'i',
    hsm_edit_data: 'Edytuj dane',
    hsm_space_name_label: 'Nazwa Twojej przestrzeni',
    update_btn: 'Odśwież',
    hsm_cycle_control_header: 'Zarządzanie cyklami i Danymi',
    hsm_start_new_cycle: 'Rozpocznij nowy cykl miesięczny',
    hsm_reset_cycle_confirm: 'Zresetować punkty XP i rozpocząć nowy miesiąc?',
    hsm_confirm_cycle: 'Tak, rozpocznij cykl',
    hsm_factory_reset: 'Zacznij od nowa (Ustawienia fabryczne)',
    hsm_factory_reset_confirm: 'Uwaga! Zresetować WSZYSTKIE dane i przywrócić domyślne zadania?',
    hsm_reset_all_btn: 'Zresetuj wszystko!',
    hsm_partner_invite: 'Zaproszenie partnera',
    hsm_invite_code: 'Kod: {code}',
    hsm_invite_desc: 'Wyślij kartę zaproszenia partnerowi do automatycznej weryfikacji i synchronizacji.',
    hsm_invite_msg: '🤝 Cześć! Zapraszam Cię do wspólnego prowadzenia domu w DuoDone! 🏓✨\n\nPrzyjmij zaproszenie jako mój partner ({partner}):\n{link}',
    hsm_invite_title: 'Zaproszenie DuoDone',
    hsm_join_code_label: 'Dołącz do domu partnera za pomocą kodu',
    hsm_join_code_ph: 'Wpisz kod, np. DUO-7789',
    hsm_join_btn: 'Dołącz',
    hsm_join_success: 'Pomyślnie dołączono do wspólnego domu!',
    hsm_join_error: 'Kod nie został znaleziony w chmurze.',
    hsm_space_status_locked: '🔒 Chroniony (2/2 partnerów)',
    hsm_space_status_open: '🟡 Oczekuje na 2. partnera (1/2)',
    hsm_space_create_btn: '➕ Stwórz новую przestrzeń',
    hsm_space_full_error: 'Ta przestrzeń ma już 2 partnerów. Utwórz własną przestrzeń!',
    header_my_spaces: 'Twoje Przestrzenie',
    header_create_space: '➕ Stwórz nową przestrzeń',
    csm_title: 'Tworzenie nowej przestrzeni',
    csm_subtitle: 'Prowadź osobne gospodarstwo z innym partnerem',
    csm_name_label: 'Nazwa przestrzeni (np. Dom z bratem)',
    csm_name_ph: 'Wpisz nazwę przestrzeni...',
    csm_submit_btn: 'Stwórz przestrzeń 🚀',
    csm_creating: 'Tworzenie...',
    sm_title: 'Zarządzanie Przestrzeniami',
    sm_subtitle: 'Przeglądaj, edytuj przestrzenie i zarządzaj dostępem',
    sm_disconnect_partner: 'Odłącz partnera',
    sm_disconnect_confirm: 'Odłączyć partnera z tej przestrzeni? Kod zaproszenia zostanie ponownie otwarty dla nowego konta.',
    sm_delete_space: 'Usuń przestrzeń',
    sm_delete_confirm: 'Usunąć tę przestrzeń? Wszystkie zadania i dane zostaną usunięte.',
    sm_manage_spaces_btn: 'Zarządzaj przestrzeniami ⚙️',
    sm_active_badge: 'Aktywny',
    sm_switch_btn: 'Wybierz',
    eum_photo_name: 'Zdjęcie i Imię',
    eum_change_photo: 'Zmień zdjęcie',
    eum_partner1_ph: 'Imię partnera 1',
    eum_partner2_ph: 'Imię partnera 2',
    ...
    // Counter Modal
    cm_photo_req_desc: 'Wymagane dodanie 1 lub 2 zdjęć',
    cm_photo_opt_desc: 'Dodaj do 2 zdjęć opcjonalnie lub zatwierdź bez zdjęcia',
    ...
    cm_add_second_photo: '+ Dodaj drugie zdjęcie',
    cm_photos_count: '{count}/2 zdjęcia',
  ...
  de: {
    ...
    // Household Share Modal
    hsm_title: 'Raum- & Partner-Einstellungen',
    hsm_subtitle: 'Partnernamen, Raumname & Einladungen',
    hsm_partners_in_app: 'Partner in der App',
    and: 'und',
    hsm_edit_data: 'Daten bearbeiten',
    hsm_space_name_label: 'Name Ihres Raumes',
    update_btn: 'Aktualisieren',
    hsm_cycle_control_header: 'Zyklus- & Datenverwaltung',
    hsm_start_new_cycle: 'Neuen Monatszyklus starten',
    hsm_reset_cycle_confirm: 'XP-Punkte zurücksetzen und neuen Monat starten?',
    hsm_confirm_cycle: 'Ja, Zyklus starten',
    hsm_factory_reset: 'Neu starten (Werkseinstellungen)',
    hsm_factory_reset_confirm: 'Achtung! ALLE Daten zurücksetzen und Vorlagen wiederherstellen?',
    hsm_reset_all_btn: 'Alles zurücksetzen!',
    hsm_partner_invite: 'Partnereinladung',
    hsm_invite_code: 'Code: {code}',
    hsm_invite_desc: 'Senden Sie eine Einladungskarte an Ihren Partner zur automatischen Verifizierung.',
    hsm_invite_msg: '🤝 Hallo! Ich lade dich ein, unseren Haushalt gemeinsam in DuoDone zu führen! 🏓✨\n\nNimm die Einladung als mein Partner ({partner}) an:\n{link}',
    hsm_invite_title: 'DuoDone Einladung',
    hsm_join_code_label: 'Dem Haushalt des Partners per Code beitreten',
    hsm_join_code_ph: 'Code eingeben, z.B. DUO-7789',
    hsm_join_btn: 'Beitreten',
    hsm_join_success: 'Erfolgreich dem gemeinsamen Haushalt beigetreten!',
    hsm_join_error: 'Code in der Cloud nicht gefunden.',
    hsm_space_status_locked: '🔒 Geschützt (2/2 Partner)',
    hsm_space_status_open: '🟡 Wartet auf 2. Partner (1/2)',
    hsm_space_create_btn: '➕ Neuen Raum erstellen',
    hsm_space_full_error: 'Dieser Raum hat bereits 2 Partner. Bitte erstellen Sie Ihren eigenen Raum!',
    header_my_spaces: 'Ihre Räume',
    header_create_space: '➕ Neuen Raum erstellen',
    csm_title: 'Neuen Raum erstellen',
    csm_subtitle: 'Verwalten Sie einen separaten Haushalt mit einem anderen Partner',
    csm_name_label: 'Raumname (z. B. Haushalt mit Bruder)',
    csm_name_ph: 'Raumnamen eingeben...',
    csm_submit_btn: 'Raum erstellen 🚀',
    csm_creating: 'Erstelle...',
    sm_title: 'Räume verwalten',
    sm_subtitle: 'Räume anzeigen, bearbeiten und Partnerzugriff verwalten',
    sm_disconnect_partner: 'Partner trennen',
    sm_disconnect_confirm: 'Partner von diesem Raum trennen? Der Einladungscode wird für ein neues Konto wieder geöffnet.',
    sm_delete_space: 'Raum löschen',
    sm_delete_confirm: 'Diesen Raum löschen? Alle Aufgaben und Daten in diesem Raum werden gelöscht.',
    sm_manage_spaces_btn: 'Räume verwalten ⚙️',
    sm_active_badge: 'Aktiv',
    sm_switch_btn: 'Wechseln',
    eum_photo_name: 'Foto & Name',
    eum_change_photo: 'Foto ändern',
    eum_partner1_ph: 'Name von Partner 1',
    eum_partner2_ph: 'Name von Partner 2',
    ...
    // Counter Modal
    cm_photo_req_desc: 'Bitte 1 oder 2 Fotos hinzufügen',
    cm_photo_opt_desc: 'Bis zu 2 Fotos optional hinzufügen oder ohne Foto bestätigen',
    ...
    cm_add_second_photo: '+ 2. Foto hinzufügen',
    cm_photos_count: '{count}/2 Fotos',
  ...
  es: {
    ...
    // Household Share Modal
    hsm_title: 'Ajustes de Espacio y Parejas',
    hsm_subtitle: 'Nombres de parejas, nombre del hogar e invitaciones',
    hsm_partners_in_app: 'Parejas en la aplicación',
    and: 'y',
    hsm_edit_data: 'Editar datos',
    hsm_space_name_label: 'Nombre de tu espacio',
    update_btn: 'Actualizar',
    hsm_cycle_control_header: 'Gestión de Ciclos y Datos',
    hsm_start_new_cycle: 'Iniciar nuevo ciclo mensual',
    hsm_reset_cycle_confirm: '¿Reiniciar puntos XP y comenzar un nuevo mes?',
    hsm_confirm_cycle: 'Sí, iniciar ciclo',
    hsm_factory_reset: 'Comenzar de nuevo (Ajustes de fábrica)',
    hsm_factory_reset_confirm: '¡Atención! ¿Reiniciar TODOS los datos y restaurar plantilla?',
    hsm_reset_all_btn: '¡Restablecer todo!',
    hsm_partner_invite: 'Invitación de pareja',
    hsm_invite_code: 'Código: {code}',
    hsm_invite_desc: 'Envía una tarjeta de invitación a tu pareja para verificación automática.',
    hsm_invite_msg: '🤝 ¡Hola! Te invito a gestionar nuestro hogar juntos en DuoDone! 🏓✨\n\nAcepta la invitación como mi pareja ({partner}):\n{link}',
    hsm_invite_title: 'Invitación DuoDone',
    hsm_join_code_label: 'Unirse al hogar de la pareja por código',
    hsm_join_code_ph: 'Introduce el código, ej. DUO-7789',
    hsm_join_btn: 'Unirse',
    hsm_join_success: '¡Unido con éxito al hogar compartido!',
    hsm_join_error: 'Código no encontrado en la nube.',
    hsm_space_status_locked: '🔒 Protegido (2/2 parejas)',
    hsm_space_status_open: '🟡 Esperando a la 2ª pareja (1/2)',
    hsm_space_create_btn: '➕ Crear nuevo espacio',
    hsm_space_full_error: '¡Este espacio ya tiene 2 parejas. Crea tu propio espacio!',
    header_my_spaces: 'Tus Espacios',
    header_create_space: '➕ Crear nuevo espacio',
    csm_title: 'Crear Nuevo Espacio',
    csm_subtitle: 'Gestiona un hogar independiente con otro compañero',
    csm_name_label: 'Nombre del espacio (ej. Hogar con hermano)',
    csm_name_ph: 'Ingrese el nombre del espacio...',
    csm_submit_btn: 'Crear Espacio 🚀',
    csm_creating: 'Creando...',
    sm_title: 'Gestionar Espacios',
    sm_subtitle: 'Ver, editar espacios y gestionar el acceso del compañero',
    sm_disconnect_partner: 'Desconectar compañero',
    sm_disconnect_confirm: '¿Desconectar compañero de este espacio? El código de invitación se reabrirá para una nueva cuenta.',
    sm_delete_space: 'Eliminar espacio',
    sm_delete_confirm: '¿Eliminar este espacio? Se eliminarán todas las tareas y datos de este espacio.',
    sm_manage_spaces_btn: 'Gestionar espacios ⚙️',
    sm_active_badge: 'Activo',
    sm_switch_btn: 'Seleccionar',
    eum_photo_name: 'Foto y Nombre',
    eum_change_photo: 'Cambiar foto',
    eum_partner1_ph: 'Nombre de pareja 1',
    eum_partner2_ph: 'Nombre de pareja 2',
    ...
    // Counter Modal
    cm_photo_req_desc: 'Adjunta 1 o 2 fotos obligatoriamente',
    cm_photo_opt_desc: 'Añade hasta 2 fotos opcionales o confirma sin foto',
    ...
    cm_add_second_photo: '+ Añadir 2ª foto',
    cm_photos_count: '{count}/2 fotos',
  ...
  fr: {
    ...
    // Household Share Modal
    hsm_title: 'Paramètres de l\'Espace et des Partenaires',
    hsm_subtitle: 'Noms des partenaires, titre du foyer & invitations',
    hsm_partners_in_app: 'Partenaires dans l\'application',
    and: 'et',
    hsm_edit_data: 'Modifier les données',
    hsm_space_name_label: 'Nom de votre espace',
    update_btn: 'Mettre à jour',
    hsm_cycle_control_header: 'Gestion des cycles & Données',
    hsm_start_new_cycle: 'Démarrer un nouveau cycle mensuel',
    hsm_reset_cycle_confirm: 'Réinitialiser les points XP et démarrer un nouveau mois ?',
    hsm_confirm_cycle: 'Oui, démarrer le cycle',
    hsm_factory_reset: 'Recommencer à zéro (Réinitialisation d\'usine)',
    hsm_factory_reset_confirm: 'Attention ! Réinitialiser TOUTES les données et restaurer les modèles ?',
    hsm_reset_all_btn: 'Tout réinitialiser !',
    hsm_partner_invite: 'Invitation du partenaire',
    hsm_invite_code: 'Code : {code}',
    hsm_invite_desc: 'Envoyez une carte d\'invitation à votre partenaire pour une vérification automatique.',
    hsm_invite_msg: '🤝 Bonjour ! Je vous invite à gérer notre foyer ensemble dans DuoDone ! 🏓✨\n\nAcceptez l\'invitation en tant que mon partenaire ({partner}) :\n{link}',
    hsm_invite_title: 'Invitation DuoDone',
    hsm_join_code_label: 'Rejoindre le foyer du partenaire par code',
    hsm_join_code_ph: 'Entrez le code, ex. DUO-7789',
    hsm_join_btn: 'Rejoindre',
    hsm_join_success: 'Rejoint avec succès le foyer partagé !',
    hsm_join_error: 'Code introuvable dans le cloud.',
    hsm_space_status_locked: '🔒 Protégé (2/2 partenaires)',
    hsm_space_status_open: '🟡 En attente du 2ème partenaire (1/2)',
    hsm_space_create_btn: '➕ Créer un nouvel espace',
    hsm_space_full_error: 'Cet espace a déjà 2 partenaires. Veuillez créer votre propre espace !',
    header_my_spaces: 'Vos espaces',
    header_create_space: '➕ Créer un nouvel espace',
    csm_title: 'Créer un nouvel espace',
    csm_subtitle: 'Gérez un foyer séparé avec un autre partenaire',
    csm_name_label: 'Nom de l\'espace (ex. : Foyer avec mon frère)',
    csm_name_ph: 'Entrez le nom de l\'espace...',
    csm_submit_btn: 'Créer l\'espace 🚀',
    csm_creating: 'Création en cours...',
    sm_title: 'Gérer les espaces',
    sm_subtitle: 'Afficher, modifier les espaces et gérer l\'accès des partenaires',
    sm_disconnect_partner: 'Déconnecter le partenaire',
    sm_disconnect_confirm: 'Déconnecter le partenaire de cet espace ? Le code d\'invitation sera rouvert pour un nouveau compte.',
    sm_delete_space: 'Supprimer l\'espace',
    sm_delete_confirm: 'Supprimer cet espace ? Toutes les tâches et données de cet espace seront effacées.',
    sm_manage_spaces_btn: 'Gérer les espaces ⚙️',
    sm_active_badge: 'Actif',
    sm_switch_btn: 'Changer',
    eum_photo_name: 'Photo & Nom',
    eum_change_photo: 'Changer de photo',
    eum_partner1_ph: 'Nom du partenaire 1',
    eum_partner2_ph: 'Nom du partenaire 2',

    // Quick Start Banner
    quick_start_title: 'Tout est prêt ! Aucune configuration requise 🎉',
    quick_start_desc: 'Nous avons déjà créé des tâches (🧽 Faire la vaisselle, 🗑️ Sortir les poubelles) et des compteurs. Appuyez simplement !',
    quick_start_btn: 'Génial, c\'est parti ! 🚀',

    // Cycle Banner
    cycle_countdown: '⏳ Le cycle se termine dans :',
    cycle_leading: 'Vous menez de',
    cycle_trailing: 'En tête :',
    cycle_tie: 'Égalité :',
    cycle_finished_title: 'Tour terminé ! 🏆',
    cycle_winner_msg: 'Super travail pendant ce cycle ! 🌟',
    cycle_loser_msg: 'Malheureusement, la chance était du côté du partenaire cette fois...',
    cycle_tie_msg: 'Match nul ! Un beau combat 🤝',
    go_to_roulette: 'Aller à la Roulette 🎡',
    cycle_winner_sub: 'Il est temps de faire tourner la roue de la chance pour votre récompense ! 🎁',
    cycle_loser_sub: 'Il est temps de faire tourner la roue des pénalités et d\'accomplir la tâche ! ⚡',
    cycle_tie_sub: 'Tous les deux méritent une récompense ! Tournez la roulette 🎡',
    cycle_btn_prizes: 'Voir les récompenses 🎁',
    cycle_btn_penalties: 'Tourner la roulette des pénalités ⚡',

    // Balancer Card
    balancer_title: 'Équilibreur de points',
    balancer_subtitle: 'Score commun & Soutien du partenaire',
    balancer_tag: 'HARMONIE',
    balancer_season: 'Saison',
    balancer_equal: 'Harmonie des points ! 🤝 Contribution commune',
    ...
    task_your_turn: 'À votre tour ! 👈',
    task_partner_turn: 'Au tour du partenaire',
    task_done_btn: 'Terminé ! Passer le tour 🚀',
    ...
    counters_hide: 'Masquer les compteurs supplémentaires',

    // Calendar
    calendar_timeline_title: 'Chronologie des activités pour',
    calendar_events_count: 'événements',
    calendar_no_activity: 'Aucune activité enregistrée ce jour-là.',
    calendar_photo_btn: 'Photo',

    // Roulette Wheel
    roulette_final_title: 'Bilan de la période (Finale)',
    roulette_winner_label: 'Vainqueur du cycle :',
    roulette_tie_label: 'Égalité ! Combat équilibré 🤝',
    roulette_prizes_tab: 'Prix (Pour le vainqueur)',
    roulette_penalties_tab: 'Pénalités (Pour le second)',
    roulette_spin_btn: 'TOURNER LA ROUE 🎡',
    roulette_spinning: 'Rotation...',
    ...
    // Settings
    settings_language: 'Langue de l\'application / Language',
    settings_language_desc: 'Choisissez la langue pour votre couple',
    settings_cat: 'Conseiller Félin 🐱',
    settings_cat_desc: 'Assistant personnel avec humour et conseils',
    settings_dashboard: 'Configurateur de l\'écran d\'accueil ⚙️',
    ...
    copy_invite_btn: 'Copier le texte de l\'invitation 📋',
    invite_copied: 'Copié ! 📋',

    // Configurator
    configurator_title: 'Configurateur d\'accueil',
    configurator_subtitle: 'Choisissez les widgets et tuiles pour un accès rapide',
    configurator_balancer_label: 'Afficher le widget de balance XP',
    configurator_balancer_desc: 'Afficher le graphique de tir à la corde en haut',
    configurator_tasks_header: 'Files d\'attente de ping-pong actives ({count})',
    ...
    tm_counter_title_ph: 'Ex. : Acheter de la nourriture pour chat',
    tm_emoji_label: 'Sélection d\'emoji',
    tm_selected: 'Sélectionné : {icon}',
    tm_emoji_ph: 'Entrez un emoji...',
    ...
    tm_photo_mode_label: 'Mode de confirmation par photo',
    tm_photo_none: 'Sans photo',
    tm_photo_optional: 'Facultatif',
    tm_photo_required: 'Obligatoire',
    tm_counter_step: 'Pas de comptage',
    tm_total_count: 'Total : {count}',
    cat_household: '🧹 Entretien',
    cat_food: '🍳 Cuisine',
    ...
    // Roulette Manager
    rm_title: 'Secteurs de la Roulette',
    rm_subtitle: 'Gérer les prix et les pénalités',
    rm_prizes_tab: 'Prix du vainqueur ({count})',
    rm_penalties_tab: 'Pénalités ({count})',
    rm_prize_ph: 'Nouveau prix (ex. : Massage 30 min)',
    rm_penalty_ph: 'Nouvelle pénalité (ex. : Laver les vitres)',
    add_btn: 'Ajouter',

    // Cat Settings
    cat_settings_title: 'Conseiller Félin',
    cat_settings_subtitle: 'Conseils amusants pour maintenir la paix',
    cat_name_label: 'Entrez un nom pour votre chat :',
    ...
    // Counter Modal
    cm_photo_req_desc: 'Veuillez joindre 1 ou 2 photos',
    cm_photo_opt_desc: 'Ajoutez jusqu\'à 2 photos facultatives ou confirmez sans photo',
    ...
    cm_add_second_photo: '+ Ajouter 2ème photo',
    cm_photos_count: '{count}/2 photos',
  ...
  ru: {
    ...
    cancel: 'Отмена',
    tg_id_bound: 'TG ID: Привязан при входе',
    tg_id_invite: 'TG ID: Привязан при принятии инвайта',

    // Household Share Modal
    hsm_title: 'Настройки Пространства и Партнеров',
    hsm_subtitle: 'Имена партнеров, название дома и инвайты',
    hsm_partners_in_app: 'Партнеры в приложении',
    and: 'и',
    hsm_edit_data: 'Редактировать данные',
    hsm_space_name_label: 'Название вашего пространства',
    update_btn: 'Обновить',
    hsm_cycle_control_header: 'Управление циклами и Данными',
    hsm_start_new_cycle: 'Начать новый месячный цикл',
    hsm_reset_cycle_confirm: 'Сбросить очки XP и начать новый месяц?',
    hsm_confirm_cycle: 'Да, начать цикл',
    hsm_factory_reset: 'Начать с чистого листа (Сброс до заводских)',
    hsm_factory_reset_confirm: 'Внимание! Сбросить ВСЕ данные и восстановить шаблоны?',
    hsm_reset_all_btn: 'Сбросить все!',
    hsm_partner_invite: 'Инвайт партнера',
    hsm_invite_code: 'Код: {code}',
    hsm_invite_desc: 'Отправьте карточку-приглашение партнеру для автоматической верификации.',
    hsm_invite_msg: '🤝 Привет! Приглашаю тебя вести наш быт вместе в DuoDone! 🏓✨\n\nПрими приглашение как мой партнер ({partner}):\n{link}',
    hsm_invite_title: 'Приглашение в DuoDone',
    hsm_join_code_label: 'Присоединиться к дому партнера по коду',
    hsm_join_code_ph: 'Введите код, напр. DUO-7789',
    hsm_join_btn: 'Присоединиться',
    hsm_join_success: 'Успешно присоединились к совместному дому!',
    hsm_join_error: 'Код не найден в облаке.',
    hsm_space_status_locked: '🔒 Защищено (2/2 партнера)',
    hsm_space_status_open: '🟡 Ожидает 2-го партнера (1/2)',
    hsm_space_create_btn: '➕ Создать новое пространство',
    hsm_space_full_error: 'В этом пространстве уже 2 партнера. Создайте свое личное пространство!',
    header_my_spaces: 'Ваши пространства',
    header_create_space: '➕ Создать новое пространство',
    csm_title: 'Создать новое пространство',
    csm_subtitle: 'Ведите отдельный быт с другим партнером',
    csm_name_label: 'Название пространства (напр. Быт с братом)',
    csm_name_ph: 'Введите название пространства...',
    csm_submit_btn: 'Создать пространство 🚀',
    csm_creating: 'Создание...',
    sm_title: 'Управление пространствами',
    sm_subtitle: 'Просмотр, редактирование пространств и доступа партнеров',
    sm_disconnect_partner: 'Отключить партнера',
    sm_disconnect_confirm: 'Отключить партнера от этого пространства? Код инвайта снова станет открытым для нового аккаунта.',
    sm_delete_space: 'Удалить пространство',
    sm_delete_confirm: 'Удалить это пространство? Все задачи и данные в нем будут стерты.',
    sm_manage_spaces_btn: 'Управление пространствами ⚙️',
    sm_active_badge: 'Активно',
    sm_switch_btn: 'Перейти',
    eum_photo_name: 'Фото и Имя',
    eum_change_photo: 'Изменить фото',
    eum_partner1_ph: 'Имя Партнера 1',
    eum_partner2_ph: 'Имя Партнера 2',

    // Quick Start Banner
    quick_start_title: 'Все готово! Ничего настраивать не нужно 🎉',
    quick_start_desc: 'Мы уже создали задачи (🧽 Помыть посуду, 🗑️ Вынести мусор) и счетчики. Просто нажимайте!',
    quick_start_btn: 'Класс, погнали! 🚀',

    // Cycle Banner
    cycle_countdown: '⏳ Цикл завершается через:',
    cycle_leading: 'Вы лидируете на',
    cycle_trailing: 'Лидирует:',
    cycle_tie: 'Ничья по очкам:',
    cycle_finished_title: 'Раунд Завершен! 🏆',
    cycle_winner_msg: 'Отличная работа в этом цикле! 🌟',
    cycle_loser_msg: 'Увы, удача была на стороне партнера в этот раз...',
    cycle_tie_msg: 'Боевая ничья! Отличный поединок 🤝',
    go_to_roulette: 'К Рулетке 🎡',
    cycle_winner_sub: 'Пора крутить колесо удачи за твою заслуженную награду! 🎁',
    cycle_loser_sub: 'Пора крутить штрафную рулетку и выполнять наказание! ⚡',
    cycle_tie_sub: 'Оба заслужили награду! Крутите рулетку 🎡',
    cycle_btn_prizes: 'К наградам 🎁',
    cycle_btn_penalties: 'Крутить штрафную рулетку ⚡',

    // Balancer Card
    balancer_title: 'Балансир очков',
    balancer_subtitle: 'Общий счет и поддержка партнера',
    balancer_tag: 'ГАРМОНИЯ',
    balancer_season: 'Сезон',
    balancer_equal: 'Гармония очков! 🤝 Совместный вклад',
    balancer_lead: 'с отрывом в',

    // Tasks section
    tasks_section_title: 'Очередь «DuoDone» (Задачи)',
    tasks_active_count: 'активных',
    tasks_empty: 'Нет закрепленных задач. Включите их в настройках!',
    task_your_turn: 'Ваш ход! 👈',
    task_partner_turn: 'Ход партнера',
    task_done_btn: 'Готово! Передать ход 🚀',
    ...
    // Calendar
    calendar_timeline_title: 'Хронология активности за',
    calendar_events_count: 'событий',
    calendar_no_activity: 'В этот день не было зафиксировано активности.',
    calendar_photo_btn: 'Фото',

    // Roulette Wheel
    roulette_final_title: 'Итоги периода (Финал)',
    roulette_winner_label: 'Победитель цикла:',
    roulette_tie_label: 'Ничья! Равная борьба 🤝',
    roulette_prizes_tab: 'Призы (Для победителя)',
    roulette_penalties_tab: 'Штрафы (Для занявшего 2 место)',
    roulette_spin_btn: 'КРУТИТЬ КОЛЕСО 🎡',
    roulette_spinning: 'Вращение...',
    roulette_winner_choice: 'Случайный выбор судьбы:',
    roulette_cycle_question: 'Когда вы хотите завершать цикл?',
    roulette_weekly: '📅 Еженедельно (7д)',
    roulette_monthly: '📆 Ежемесячно (30д)',
    roulette_custom: '⚙️ Свой период',
    roulette_off: '⏸️ Без таймера',
    ...
    settings_language_desc: 'Выберите удобный язык для вашей пары',
    settings_cat: 'Консультант-Котик 🐱',
    ...
    // Configurator
    configurator_title: 'Конфигуратор экрана',
    configurator_subtitle: 'Выберите виджеты и плитки для быстрого доступа',
    configurator_balancer_label: 'Показывать виджет XP баланса',
    configurator_balancer_desc: 'Отображать график перетягивания каната сверху',
    configurator_tasks_header: 'Активные пинг-понг очереди ({count})',
    configurator_counters_header: 'Быстрые счетчики-плитки ({count})',
    show_btn: 'Показать',
    hide_btn: 'Скрыть',
    on_dashboard_btn: 'На главном',
    in_archive_btn: 'В архиве',

    // Task & Counter manager
    tm_tasks_tab: 'Задачи DuoDone ({count})',
    tm_counters_tab: 'Счетчики ({count})',
    create_btn: 'Создать',
    tm_edit_task: 'Редактировать задачу DuoDone',
    tm_create_task: 'Создать новую задачу DuoDone',
    tm_edit_counter: 'Редактировать счетчик',
    tm_create_counter: 'Создать новый счетчик',
    tm_task_title_label: 'Название задачи',
    tm_task_title_ph: 'Напр.: Помыть пол',
    tm_counter_title_label: 'Название счетчика',
    tm_counter_title_ph: 'Напр.: Купить кошачий корм',
    tm_emoji_label: 'Выбор эмодзи',
    tm_selected: 'Выбрано: {icon}',
    tm_emoji_ph: 'Введите эмодзи...',
    tm_xp_cost: 'Стоимость в XP (1 - 5)',
    ...
    rm_prize_ph: 'Новый приз (напр.: Массаж 30 мин)',
    rm_penalty_ph: 'Новое наказание (напр.: Мытье окон)',
    add_btn: 'Добавить',

    // Cat Settings
    cat_settings_title: 'Консультант-Котик',
    cat_settings_subtitle: 'Забавные мотивирующие советы для мира',
    ...
    // Counter Modal
    cm_photo_req_desc: 'Обязательно добавьте 1 или 2 фото',
    cm_photo_opt_desc: 'Добавьте до 2 фото по желанию или подтвердите без фото',
    ...
    cm_add_second_photo: '+ Добавить 2-е фото',
    cm_photos_count: '{count}/2 фото',
